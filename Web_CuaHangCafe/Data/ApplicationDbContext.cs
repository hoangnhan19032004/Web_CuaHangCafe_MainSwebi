...
namespace Web_CuaHangCafe.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        // ✅ Thêm mới cho chức năng size
        public DbSet<TbSize> TbSizes { get; set; }
        public DbSet<TbSanPhamSize> TbSanPhamSizes { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // ✅ Cấu hình bảng tbSize
            modelBuilder.Entity<TbSize>(entity =>
            {
                entity.HasKey(e => e.MaSize);
                entity.ToTable("tbSize");

                entity.Property(e => e.TenSize).HasMaxLength(20).IsRequired();
                entity.Property(e => e.HeSoGia).HasColumnType("decimal(5,2)").HasDefaultValue(0);
            });

            // ✅ Cấu hình bảng trung gian tbSanPhamSize
            modelBuilder.Entity<TbSanPhamSize>(entity =>
            {
                entity.HasKey(e => new { e.MaSanPham, e.MaSize });
                entity.ToTable("tbSanPhamSize");

                entity.HasOne(e => e.TbSanPham)
                      .WithMany(sp => sp.TbSanPhamSizes)
                      .HasForeignKey(e => e.MaSanPham);

                entity.HasOne(e => e.TbSize)
                      .WithMany(sz => sz.TbSanPhamSizes)
