...
namespace Web_CuaHangCafe.Migrations
{
    ...
    [Migration("20250718084745_AddGhiChuToChiTietHoaDonBan")]
    partial class AddGhiChuToChiTietHoaDonBan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_CuaHangCafe.Models.TbSanPhamSize", b =>
                {
                    b.Property<int>("MaSanPham")
                        .HasColumnType("int");
                    ...
                    b.ToTable("tbSanPhamSize", (string)null);
                });

            modelBuilder.Entity("Web_CuaHangCafe.Models.TbSize", b =>
                {
                    b.Property<int>("MaSize")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_CuaHangCafe.Models.TbSanPhamSize", b =>
                {
                    b.HasOne("Web_CuaHangCafe.Models.TbSanPham", "TbSanPham")
                        .WithMany("TbSanPhamSizes")
                        .HasForeignKey("MaSanPham")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Web_CuaHangCafe.Models.TbSize", "TbSize")
                        .WithMany("TbSanPhamSizes")
